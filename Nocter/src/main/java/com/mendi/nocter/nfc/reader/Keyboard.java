package com.mendi.nocter.nfc.reader;

import com.mendi.nocter.MainController;
...
public class Keyboard {
	 ...
	 */
	@SneakyThrows
	public Keyboard(SystemStatus systemStatus) {
	...
	public void type(CharSequence characters) {
		...
		for (int i = 0; i < length; i++) {
			...
			//type(character);
                ...
                this.systemStatus.NFCTagReaded(tmpText);
	}
